...
[X,Y,Z]=ndgrid(1:size(truth,1),1:size(truth,2),1:size(truth,3));
iso1 = isosurface(X,Y,Z,truth == 1, 0);
iso2 = isosurface(X,Y,Z,estimate == 1, 0);
vert1 = iso1.vertices;
vert2 = iso2.vertices;
clear iso1 iso2
