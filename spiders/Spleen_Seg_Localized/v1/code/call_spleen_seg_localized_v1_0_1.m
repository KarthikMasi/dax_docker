...
target_image='/fs1/masi/zhoubing/MICCAI-2015-SATA/Abdomen/RawData/Testing/img/img0072.nii.gz';
% ======================================================================= %
...
reg_param=struct;
reg_param.num_levels=5;
reg_param.num_threads=2; 
reg_param.ref_up_thresh=500;
reg_param.in_up_thresh=500;
reg_param.maxit=1000;
...
spleen_seg_localized_v2(target_image,out_dir,...
