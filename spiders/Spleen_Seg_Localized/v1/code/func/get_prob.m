function get_prob(image,model_mat,landmark_mat,prob_mat)
% compute the organ-wise probablity
...
% gather fat/muscle/other as background -> Est(:,1)
Est=cat(2,sum(Est(:,end-2:end),2),Est(:,1:end-3));
