function spleen_seg_localized(target_image,out_dir,...
...
spleen_registration(mod_image,tgtfn,sub_dir,tools,reg_param,atlas_loc);
disp('spleen context learning');
spleen_context_learning(mod_image,tgtfn,sub_dir,cl_param);
disp('spleen fusion');
spleen_fusion(mod_image,tgtfn,sub_dir,tools,fusion_param);
