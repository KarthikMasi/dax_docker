...
public class RunLocalizationTestingCentroids_CASCADE {
	public static void main(String[] args) throws Exception {
		if (args.length != 6 && args.length != 7) {
			System.out.println("6 or 7 input arguments are required.");
			...
			System.out.println("7. confidentDataPercentage");
			return;
		}
		...
		double pad = 80; // pad 80 mm to each boundary
		...
		double[][] box_global = ForestTesterHistPlus.TestForest(dc, forest, classCount, dimCount,confidentDataPercentage);
		...
		for (int c = 0; c < classCount; c++){
			...
			System.out.println("testing ...");
			double[][] box_organ = ForestTesterHistPlus.TestForest(organDC, organForest, classCountOrgan, dimCount,confidentDataPercentage);
